...
sudo pacman -S --needed --noconfirm \
  ...
  wireplumber pavucontrol easyeffects # pipewire-jack  [CachyOS paquete-remomovido-deleted-delete-borrado]
...
# Paquetes base de emojis y fuentes (incluyendo Mononoki)
print_installing "Emojis y Mononoki Nerd Font"
sudo pacman -S --needed --noconfirm \
  noto-fonts-emoji \
  ttf-mononoki-nerd \
...
# [Remplazar por instalacion de LightDM-webkit2 PRO THEME para Cachy/Endeavor OS, Plasma].
# (Para no romper plasma)
# ═══════════════════════════════════════════════════════════
