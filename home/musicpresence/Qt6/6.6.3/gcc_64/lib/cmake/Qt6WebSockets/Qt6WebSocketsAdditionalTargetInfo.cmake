...
get_target_property(_qt_imported_soname Qt6::WebSockets IMPORTED_SONAME_RELWITHDEBINFO)
...
if(_qt_imported_soname)
    set_property(TARGET Qt6::WebSockets PROPERTY IMPORTED_SONAME_RELEASE "${_qt_imported_soname}")
endif()
